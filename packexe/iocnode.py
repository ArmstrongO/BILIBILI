...
def _add_pinglun():
    while 1:
        ...
        try:
            res= requests.post(url=f"{url}topic/64326140c16f1543e053ec80/replies",json=date)
...
def _add_pinglun2():
    while 1:
        ...
        try:
            res= requests.post(url=f"{url}topic/6432613fc16f1543e053ec7f/replies",json=date)
            res.raise_for_status ()
        except requests.exceptions.RequestException as e:
...
def _add_pinglun3():
    while 1:
        ...
        try:
            res= requests.post(url=f"{url}topic/6432613fc16f1543e053ec7e/replies",json=date)
            res.raise_for_status ()
        except requests.exceptions.RequestException as e:
...
def _add_pinglun4():
    while 1:
        ...
        try:
            res= requests.post(url=f"{url}topic/6432613ec16f1543e053ec7d/replies",json=date)
            res.raise_for_status ()
        except requests.exceptions.RequestException as e:
